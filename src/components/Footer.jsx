    ...
    <footer className="bg-slate-900 text-white mt-auto">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p className="flex items-start gap-2 text-[12px] md:text-[13px] text-slate-400">
              ...
              <span className="whitespace-nowrap">{contactInfo.address}</span>
            </p>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-[1240px] mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-[11px] md:text-[12px] text-slate-500 text-center sm:text-right whitespace-nowrap">{contactInfo.address}</p>
        </div>
      </div>
    </footer>
  );
